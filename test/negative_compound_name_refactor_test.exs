defmodule NegativeCompoundNameRefactorTest do
  use ExUnit.Case
  doctest Refactor
  ...
  @sample "./test/samples/negative_compound_example.ex"
  @input  "./test/samples/negative_compound_example_input.ex"
  @output "./test/samples/negative_compound_example_refactored.ex"
